...
class OrdersService {
  ...
  /// Stream berdasarkan status (Active, Completed, Cancelled)
  ...
  Future<String> createOrder(Map<String, dynamic> payload) async {
    ...
    final orderData = {
      ...
      'deliveryAddress': payload['deliveryAddress'] ?? 'No. 1 Bungo Pasang, Padang, West Sumatra',
      ...
      'image': items.isNotEmpty && items.first.containsKey('image') 
          ? items.first['image'] 
          : '',
    };
