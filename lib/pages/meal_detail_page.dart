          ...
          builder: (context, setDialogState) {
            return AlertDialog(
              ...
              actions: [
                ...
                ElevatedButton(
                  onPressed: () {
                    // Get CartProvider reference before closing dialog
                    ...
                    // Add to cart using the saved provider reference
                    cartProvider.addToCart(food!, quantity: tempQuantity);
                    ...
                    if (isAddToCart) {
                      ...
                      Navigator.pushNamed(
                        ...
                        arguments: {
                          ...
                          'subtotal':
                              (food!['price'] * tempQuantity).toDouble(),
                          'deliveryFee': 5000.0,
                          'tax':
                              (food!['price'] * tempQuantity * 0.01).toDouble(),
                          'discount':
                              (food!['price'] * tempQuantity * 0.1).toDouble(),
                          'total':
                              (food!['price'] * tempQuantity * 1.01 -
                                      food!['price'] * tempQuantity * 0.1 +
                                      5000)
                                  .toDouble(),
                        },
                      );
